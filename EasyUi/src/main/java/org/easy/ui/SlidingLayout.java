...
public class SlidingLayout extends ViewGroup {
    ...
    public SlidingLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SlidingLayout);
        mMode = Mode.getFromInt(a.getInt(R.styleable.SlidingLayout_mode,0));

        mIsCompatSliding = a.getBoolean(R.styleable.SlidingLayout_compat_sliding,false);
