...
//						Toast.LENGTH_LONG).show();
	...
	public void collectDeviceInfo() {
		try {
			PackageManager pm = EasySdk.getContext().getPackageManager();
			PackageInfo pi = pm.getPackageInfo(EasySdk.getContext().getPackageName(),
	...
	public String getLogPath(){
		if (TextUtils.isEmpty(path)) {
			return EasySdk.getContext().getExternalFilesDir(null).getAbsolutePath()+ "/crashinfo/";
		}else {
			return path;
		}
	}
